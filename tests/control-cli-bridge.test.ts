...
const MANAGED_CREDENTIALS = new Map<string, ControlCliBridgeContext>();
...
async function startRuntime(testRoot: string, label: string): Promise<RuntimeDescriptorHandle> {

...
function resolveBurstWheelDistanceRows(
  ...
  const isMomentumTail = state.lastDistanceRows !== null
  ...
  const cadence = elapsedMs <= TUI_WHEEL_BURST_FULL_INTERVAL_MS
    ? 1
  ...
  return TUI_WHEEL_BURST_MAX_BONUS_ROWS
    * cadence

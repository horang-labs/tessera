...
export const SHORTCUT_REGISTRY = {
  ...
  'previous-tab':   { default: '$mod+Alt+Shift+PageUp',   category: 'tab', descKey: 'shortcut.previousTab' },
  'next-tab':       { default: '$mod+Alt+Shift+PageDown', category: 'tab', descKey: 'shortcut.nextTab' },

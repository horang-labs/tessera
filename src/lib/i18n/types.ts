export interface I18nMessages {
  settings: {
    ...
    remoteAccess: {
      ...
      mobileSetupMissing: string;
      mobileSetupSignInRequired: string;
      mobileSetupAuthorizationRequired: string;
      mobileSetupConfiguring: string;
      mobileSetupTemporarilyUnavailable: string;
      mobileSetupOwnershipConflict: string;
      mobileSetupRetryableFailure: string;
      mobileSetupReady: string;
      mobileSetupAction: string;
      mobileSetupRetryAction: string;

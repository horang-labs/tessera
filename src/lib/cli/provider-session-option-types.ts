...
export interface ProviderSessionOptions {
   ...
   * true  → Codex: effort is sent per-turn, header shows interactive dropdown.
   * false → Claude Code: effort is set at spawn via --effort flag, header shows read-only badge.
   */

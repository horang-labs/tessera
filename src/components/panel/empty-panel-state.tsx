...
import { useState, useCallback, useContext, useEffect, useMemo, useRef, type MouseEvent } from 'react';
import { X as XIcon, KeyboardIcon, FolderGit2, ListTodo, MessageSquare, AlertCircle } from 'lucide-react';
      ...
      <div className="mx-auto w-full max-w-3xl">
        ...
        {!activeProject && (
          <p className="mt-4 text-sm text-(--text-muted)">
            {t('task.worktree.errorNoProject')}
          </p>
        )}
      </div>
    </div>

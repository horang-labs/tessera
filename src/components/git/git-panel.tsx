...
export function GitPanel({
  ...
  return (
    <aside
      className="flex h-full shrink-0 flex-col border-l border-(--chat-header-border) bg-(--sidebar-bg)"
      style={{ width }}
    >
      {isWindowsElectron ? (
      ...
      <div className="border-b border-(--chat-header-border) p-2">
        <div
          role="tablist"
          aria-label="Right panel"
          className="flex items-center gap-0.5 rounded-lg bg-(--sidebar-hover) p-0.5"
        >
          <GitPanelTabButton
